...
# 制作背景
  ...
  <br>ドリンクの名前や生産地から飲食店を検索し、そのドリンクを扱っている飲食店の一覧を表示します。(上記の①の時点で条件の設定が可能)
  <br>例えば、”新潟県の日本酒が飲みたい”という時には、日本酒検索欄の生産地に「新潟」と入力し、近隣エリアを入力すれば、近隣で新潟の日本酒を取り扱っている飲食店を一発で発見できます。  

  前職の酒類を販売する営業を行っている中で、顧客である飲食店の方から 良いお酒を仕入れたのに「あまり注文されず廃棄になった」というお話を顧客から多く伺いました。  
