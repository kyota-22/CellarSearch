...
# 制作背景
  ...
  <br>①飲食店のエリア"中野区"で店を検索
  <br>↓
  <br>②一覧ページから飲食店を選択
  <br>↓
  <br>③詳細ページのメニューから探しているドリンクの有無を確認
  <br>↓
  <br>④取り扱いが無ければ見つかるまで①〜③を繰り返し。
  
  この手間を削減しより手軽にドリンクから飲食店を見つけられるのがCellarSearchです。
  <br>ドリンクの名前や生産地から飲食店を検索し、そのドリンクを扱っている飲食店の一覧を表示します。
  <br>CellarSearchで「"青森県"の"日本酒"を扱っている"中野区"の飲食店」をすぐに見つけられます。
